...
1. Invoked from the repository root, Mastermind runs the existing-project bootstrap before the full inventory. It creates missing `.project/` files, sets `STATUS.md` to unassessed, preserves existing files, and merges agent entry guidance where needed.
