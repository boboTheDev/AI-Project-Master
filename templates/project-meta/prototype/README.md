...
This folder holds a disposable, scoped frontend candidate built by UI Prototyper from approved or clearly labeled draft UX and design. It exists to let the owner quickly see a proposed UI/UX flow, not to reach visual or implementation fidelity.
